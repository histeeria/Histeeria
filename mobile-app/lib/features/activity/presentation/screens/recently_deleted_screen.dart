...
class _RecentlyDeletedScreenState extends State<RecentlyDeletedScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final posts = await _activityService.getDeletedPosts();
      setState(() {
        _posts = posts;
        _isLoading = false;
      });
                            ...
                            child: Stack(
                              ...
                              children: [
                                imageUrl != null 
                                    ...
                                    : Center(child: Icon(Icons.delete_outline, color: AppColors.error)),
                                Positioned(
                                  bottom: 4,
                                  right: 4,
                                  child: Icon(Icons.restore_from_trash, color: Colors.white, size: 16),
                                )
                              ],
                            ),
                          );
